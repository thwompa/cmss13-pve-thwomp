...
/obj/item/device/motiondetector/m717/hacked/iro
	name = "modified M717 pocket motion detector"
	desc = "This prototype motion detector sacrifices versatility, having only the long-range mode, for size, being so small it can even fit in pockets. This one has been modified with an after-market IFF sensor to filter out IRO signals instead of USCM ones. Fight fire with fire!"
	iff_signal = FACTION_IRO

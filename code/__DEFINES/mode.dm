...
GLOBAL_LIST_INIT(ROLES_SQUAD_ALL, list(SQUAD_MARINE_1, SQUAD_MARINE_2, SQUAD_MARINE_3, SQUAD_MARINE_4, SQUAD_MARINE_5, SQUAD_MARINE_CRYO, SQUAD_MARINE_INTEL, SQUAD_UPP, SQUAD_LRRP, SQUAD_IRO))
...
GLOBAL_LIST_INIT(ROLES_AI_IRO, list(JOB_IRO_STATION_CHIEF, JOB_IRO_SCIENCE_OFFICER, JOB_IRO_TECHNICIAN, JOB_IRO_SUPERVISOR, JOB_IRO_FIELD_AGENT, JOB_IRO_CONTRACTOR))

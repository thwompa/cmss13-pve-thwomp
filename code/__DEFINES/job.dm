...
//-------- IRO --------//
#define JOB_IRO "IRO Employee"
#define JOB_IRO_STATION_CHIEF "Station Chief"
#define JOB_IRO_SCIENCE_OFFICER "Science Officer"
#define JOB_IRO_TECHNICIAN "Technician"
#define JOB_IRO_SUPERVISOR "Supervisor"
#define JOB_IRO_FIELD_AGENT "Agent"
#define JOB_IRO_CONTRACTOR "Contractor"
#define JOB_IRO_SYNTH "Synthetic"
#define IRO_JOB_LIST list(JOB_IRO_STATION_CHIEF, JOB_IRO_SCIENCE_OFFICER, JOB_IRO_TECHNICIAN, JOB_IRO_SUPERVISOR, JOB_IRO_FIELD_AGENT, JOB_IRO_CONTRACTOR, JOB_IRO_SYNTH)
